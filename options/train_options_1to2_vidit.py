...
class TrainOptions(BaseOptions):
    def __init__(self):
        ...
        which_experiment = 'exp_1to2_vidit'
        self.which_experiment = which_experiment
        self.isTrain = True

        # Setting for dataset
        self.anno = 'data/anno_VIDIT/train.txt'  # the anno file from prepare_dataset.py
        self.anno_validation = 'data/anno_VIDIT/val.txt'
        # Setting for GPU
        number_gpus = 1
        ...
        self.lr = 0.0002 * 0.5  # initial learning rate for adam
        self.lr_d = self.lr
        ...
        self.epoch = 'base'  # default='latest', which epoch to load? set to latest to use latest cached model
        ...
        self.model_name = 'three_decoder'  # ['relighting' | 'intrinsic_decomposition']
        ...
        self.gt_has_intrinsic = False
        self.cycle_ref_cons = True
        ...
        if self.output_light_condition:
            self.loss_weight_angular = 0.2
            self.loss_weight_color = 0.2
        if self.output_ori_shading:
            self.loss_weight_shading_ori = 0.0
            self.loss_weight_reconstruct = 0.2
        self.loss_weight_reflectance = 0.2
        self.loss_weight_shading_new = 0.0
